    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Laravel\Fortify\Contracts\CreatesNewUsers' => \Modules\Auth\Actions\Fortify\CreateNewUser::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/Darius/Documents/TransportSystem/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./home/Darius/Documents/TransportSystem/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware',
...
'password.confirm','password.confirmation','password.confirm.store','home',
'dashboard','profile.edit','profile.update','profile.destroy',
'appearance.edit','api.auth.index','api.auth.store','api.auth.show','api.auth.update',
'api.auth.destroy','auth.index','auth.create','auth.store','auth.show',
'auth.edit','auth.update','auth.destroy','api.user.index','api.user.store',
'api.user.show','api.user.update','api.user.destroy','user.index','user.create',
'user.store','user.show','user.edit','user.update','user.destroy',
'api.vendor.index','api.vendor.store','api.vendor.show','api.vendor.update','api.vendor.destroy',
'vendor.index','vendor.create','vendor.store','vendor.show','vendor.edit',
'vendor.update','vendor.destroy','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'app','auth::components.layouts.master','auth::index','user::components.layouts.master','user::index',
'vendor::components.layouts.master','vendor::index','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
